		...
		<nav class="navbar navbar-default">
			...
			<form name="cadastro-usuario" action="" method="POST">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="nome_usuario" name="nome" placeholder="Digite seu nome e sobrenome" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="email" class="form-control" id="email_usuario" name="email" aria-describedby="emailHelp" placeholder="Informe seu email" required>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="nummatricula" id="num_matricula" placeholder="Informe o número de matrícula" required>
				</div>

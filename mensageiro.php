      ...
      <a class="navbar-brand" href="#">Bem vindo, <?php echo $_SESSION['nome']; ?></a>
        ...
        <div class="message-right">
            ...
            if(isset($_GET['id_usuario'])){
                $usuario2 = trim(mysqli_real_escape_string($link, $_GET['id_usuario']));
                $query = mysqli_query($link, "SELECT usuario FROM usuario WHERE id_usuario='$usuario2' AND id_usuario!='$id_usuario'");
                ...
                die("Escolha o contato para iniciar a conversa.");
            }
            ?>
        </div>
        <div class="send-message">
            ...
            <div class="form-group">
                ...
                <button class="btn btn-primary" id="reply">Enviar</button> 
                <span id="error"></span>
        </div>
        </div>
    </div>
